            ...
            >
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      id="name"
                      value = {product_name} onChange={(e)=>onInputChange(e)}
                      name="product_name"
                    ></input>
                  </div>
                </div>
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      id="email"
                      value = {product_type} onChange={(e)=>onInputChange(e)}
                      name="product_type"
                    ></input>
                  </div>
                </div>
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      id="password"
                      value = {product_color} onChange={(e)=>onInputChange(e)}
                      name="product_color"
                    ></input>
                  </div>
                </div>
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      id="password2"
                      value = {product_price} onChange={(e)=>onInputChange(e)}
                      name="product_price"
                    ></input>
                  </div>
                </div>
                <div>
                  ...
                  >
                    Add Items Now <ArrowRight className="ml-2" size={16} />
                  </button>
                  <Link
                    type="button"
                    to='/admin'
